...
const MENU_DATA = [
  {
    ...
    items: [
      ...
      { name: "Солянка мясная", price: "990 ₸", description: "Густой суп с несколькими видами мяса и оливками." },
      { name: "Лагман", price: "1200 ₸", description: "Традиционное блюдо с домашней лапшой, мясом и овощами." }
    ]
  },
  {
    ...
    items: [
      ...
      { name: "Плов по-ташкентски", price: "1350 ₸", description: "Ароматный рис с мясом, морковью и нутом." },
      { name: "Котлеты домашние с пюре", price: "1250 ₸", description: "Нежные говяжьи котлеты с картофельным пюре." }
    ]
  },
  {
    ...
    items: [
      ...
      { name: "Чебурек с мясом", price: "550 ₸", description: "Хрустящее тесто с сочной мясной начинкой." },
      { name: "Медовик", price: "700 ₸", description: "Классический медовый торт со сметанным кремом." }
    ]
  }
];
